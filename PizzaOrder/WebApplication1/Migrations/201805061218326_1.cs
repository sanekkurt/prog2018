    ...
    public partial class _1 : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        SauceCheck = c.Boolean(nullable: false),
                        DrinkCheck = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.DbAddition", t => t.additions_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.DbPizzaRequirements", "additions_Id", "dbo.DbAddition");
